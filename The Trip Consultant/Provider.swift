...
class Provider {
  ...
  private let places: [Place] = [
    Place(name: "Meteora", picture: "meteora", description: "Monastery complex.", country: "Greece", ratings: 2.7, reviews: 800, comment: "Spiritual retreat!"),
    ...
    Place(name: "Statue of Liberty", picture: "liberty", description: "Symbol of freedom.", country: "USA", ratings: 4.7, reviews: 950, comment: "Incredible views of the city."),
    ...
    Place(name: "Venice Canals", picture: "venice", description: "Picturesque waterways.", country: "Italy", ratings: 3.6, reviews: 950, comment: "Romantic and unique."),
    ...
    Place(name: "Mesa Verde", picture: "mesa", description: "Ancient cliff dwellings", country: "USA", ratings: 3.5, reviews: 1000, comment: "Historic site!"),
    ...
    Place(name: "Sistine Chapel", picture: "sistine", description: "Artistic masterpiece.", country: "Vatican City", ratings: 4.9, reviews: 900, comment: "Stunning frescoes!"),
    Place(name: "Antelope Canyon", picture: "antelope", description: "Slot canyon in Arizona", country: "USA", ratings: 2.7, reviews: 950, comment: "Ethereal beauty!"),
    ...
    Place(name: "Bora Bora", picture: "bora", description: "A tropical paradise", country: "French Polynesia", ratings: 4.9, reviews: 1100, comment: "Exquisite beauty!"),
    ...
    Place(name: "Yellowstone National Park", picture: "yellowstone", description: "Geothermal wonders", country: "USA", ratings: 4.8, reviews: 1400, comment: "Natural marvels!"),
    Place(name: "Galápagos Islands", picture: "galapagos", description: "Unique wildlife", country: "Ecuador", ratings: 4.7, reviews: 1000, comment: "Natural diversity!"),
    ...
    Place(name: "Bali", picture: "bali", description: "Island paradise", country: "Indonesia", ratings: 3.8, reviews: 1050, comment: "Tropical escape!"),
    Place(name: "Uluru (Ayers Rock)", picture: "uluru", description: "Iconic sandstone formation", country: "Australia", ratings: 4.8, reviews: 900, comment: "Ancient wonder!"),
  ]
